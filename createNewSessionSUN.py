...
def createNewSession(
    ...
    try:
        # ===== Load LOG_PARENT_JSESSIONID & ENC từ sessionlog_sun.json =====
        ...
        # ===== Tạo session key =====
        url_create = f"https://tc110.resdesktop.altea.amadeus.com/app_ard/apf/do/home.taskmgr/UMCreateSessionKey;jsessionid={LOG_PARENT_JSESSIONID}"
        headers = {
            "accept": "*/*",
        ...
        print("lay enc tong")
        # ===== Login new session =====
        url_login = "https://tc110.resdesktop.altea.amadeus.com/app_ard/apf/do/loginNewSession.UM/login"
        headers = {
            "accept": "*/*",
        ...
        if match_cryptic == None:
            msg = "🔐 Token hết hạn. cần chạy lại `login1Asun.py` để làm mới token."
